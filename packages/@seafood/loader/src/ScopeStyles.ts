...
import selectorParser, { AttributeOptions } from 'postcss-selector-parser'
        ...
        node.selector = selectorParser((selectors: any) => {
            selectors.each((selector: any) => {
                ...
                if (node) {
                    ...
                    // the attribute selectors are prepended rather than
                    // appended. So all leading spaces must be eliminated
                    // to avoid problems.
