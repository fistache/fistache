...
export class ReactivityWatcher {
    ...
    public bindContext(
        executingFunction: (...args: any[]) => void
    ): (...args: any[]) => void {
    ...
    public setUpdatingFunction(
        updatingFunction?: (value: any, depth?: number) => void
    ): void {
        if (updatingFunction) {
    ...
    public getUpdatingFunction(): (
        (value: any, depth?: number) => void
    ) | null | undefined {
    ...
    public setExecutingFunction(
        executingFunction: (...args: any[]) => void
    ): void {
        this.executingFunction = executingFunction
    }

    public getExecutingFunction(): (
        (...args: any[]) => void
    ) | null | undefined {
